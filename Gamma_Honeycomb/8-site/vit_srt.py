...
run_srt_experiment(
    ...
    num_samples=int(os.environ.get("GAMMA_NUM_SAMPLES", str(3 * 2**10))),
    ...
    main_sr_lr=float(os.environ.get("GAMMA_MAIN_SR_LR", "1e-3")),
    main_sr_momentum=float(os.environ.get("GAMMA_MAIN_SR_MOMENTUM", "0.0")),
    ...
    model_type=os.environ.get("GAMMA_MODEL_TYPE", "plain"),
