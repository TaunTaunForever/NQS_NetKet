"""Direct, editable Gamma 8-site base-ViT weighted-NIS experiment."""
import os
...
CONFIG = NISRunConfig(
    ...
    num_iterations=5000,
    seed=0,
    diagnostics_dir="results/nis/gamma_8site_base",
    ...
    # Base ViT target model: no explicit lattice-relation or symmetry layer.
    embed_dim=16,
    num_heads=2,
    num_layers=4,
    mlp_hidden_dim=32,
