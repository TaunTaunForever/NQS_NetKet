"""Direct, editable Gamma 8-site symmetry-projected weighted-NIS experiment."""
import os
...
CONFIG = NISRunConfig(
    ...
    seed=0,
    diagnostics_dir="results/nis/gamma_8site_symmproj",
    ...
    # Symmetry-projected target model
    embed_dim=8,
    num_heads=2,
    num_layers=2,
    mlp_hidden_dim=16,
