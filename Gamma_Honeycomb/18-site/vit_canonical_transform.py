...
JOB_BASE = (
    ...
    f"{TODAY}_Gamma_ViT_SRonly_canonical_transform"
)
...
symmetry_perms = normalise_symmetries(symm_group)
...
plt.ylabel("Energy")
plt.title(f"{NUM_SITES}-site Kitaev canonical_transform (Amplitude-only SR → SR → PT-SR)")
plt.tight_layout()
