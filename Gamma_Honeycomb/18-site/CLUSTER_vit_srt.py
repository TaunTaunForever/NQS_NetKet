...
NUM_STARTS = 1
NUM_ITERS_WARM = 1000      # amplitude-only SR iterations
NUM_ITERS_MAIN = 4000     # main SR continuation after amplitude-only training
...
JOB_BASE = (
    ...
    f"{TODAY}_Gamma_ViT_SRonly_site_type_relation"
)
...
# ============================================================
# Site-type embeddings + expanded relation matrix
# ============================================================
...
plt.ylabel("Energy")
plt.title(f"{NUM_SITES}-site Gamma site-type relation ViT (Amplitude-only SR -> SR -> PT-SR)")
plt.tight_layout()
