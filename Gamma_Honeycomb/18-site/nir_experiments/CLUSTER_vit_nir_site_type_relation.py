...
NUM_SAMPLES_STAGE_2 = 2**12
NUM_SAMPLES_STAGE_3 = 2**12
NUM_ITERS_TOTAL = 10000
...
NIR_EFFICIENCY_THRESHOLD_STAGE_3 = 0.50
...
plt.ylabel("Energy")
plt.title(f"{NUM_SITES}-site Gamma (NIR training, site-type relation ViT)")
plt.tight_layout()
