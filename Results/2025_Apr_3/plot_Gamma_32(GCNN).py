...
samples = pd.read_table("mean_energy_run_G=1.0_32-site_5_GCNN_layers_20_width_1024_samples_2025-04-02_minSR.txt", header=None)
...
x1, x2, y1, y2 = 99000, 100000, -45.265, -45.16  # subregion of the original image
