...
samples = pd.read_table("mean_energy_run_G=1.0_96-site_4_layers_10_width_1024_samples_2025-04-21_minSR.txt", header=None)
...
plt.title("96-site GSE For FM Gamma Honeycomb Model \nusing Kernel Formalation of SGD+SR")
plt.show()
