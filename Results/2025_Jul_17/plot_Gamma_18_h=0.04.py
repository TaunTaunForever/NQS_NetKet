...
samples = pd.read_table("mean_energy_run_G=1.0_18-site_4_blocks_20_width_1024_samples_2025-07-16_h=0.04_SRt.txt", header=None)
samples['x'] = np.arange(0,len(samples[0]), 1)
#samples[0] -= (-4.76429835869187*4)
fig,axes = plt.subplots(1,1)
axes.set_xscale('log')
plt.axhline(y = -25.74582944113299 , color = 'r', linestyle = '-')
