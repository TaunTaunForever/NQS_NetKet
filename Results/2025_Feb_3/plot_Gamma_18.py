...
samples = pd.read_table("mean_energy_run_G=1.0_18-site_4_ResGCNN_blocks_6_width_65536_samples_2025-01-30.txt", header=None)
samples['x'] = np.arange(0,len(samples[0]), 1)
samples[0] -= -6.408176942411061
fig,axes = plt.subplots(1,1)
axes = plt.plot(samples['x'], samples[0])

fig.set_size_inches(10, 8)
plt.title("18-site Kitaev Honeycomb Model")
