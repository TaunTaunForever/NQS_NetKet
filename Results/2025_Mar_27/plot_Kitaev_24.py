...
samples = pd.read_table("mean_energy_run_K=-1.0_24-site_5_blocks_10_width_8192_samples_2025-03-25_minSR.txt", header=None)
...
plt.title("50-site GSE For Kitaev Honeycomb Model \nusing Kernel Formalation of SGD+SR")
