...
samples = pd.read_table("mean_energy_run_G=1.0_8-site_5_blocks_8_width_2048_samples_2025-09-01_SRt.txt", header=None)
samples['x'] = np.arange(0,len(samples[0]), 1)
#samples[0] -= (-4.76429835869187*4)
fig,axes = plt.subplots(1,1)
axes.set_xscale('log')
plt.axhline(y = -11.704518781954/4, color = 'r', linestyle = '-')
...
'''
x1, x2, y1, y2 = 9000, 10000, -6.935, -6.91  # subregion of the original image
