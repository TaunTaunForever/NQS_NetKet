...
samples = pd.read_table("mean_energy_run_K=-1.0_8-site_4_blocks_8_width_2048_samples_2025-08-28_minSR.txt", header=None)
...
new_samples = samples[-1000:]/4


x1, x2, y1, y2 = 9000, 10000, -6.93, -6.92  # subregion of the original image
