...
samples = pd.read_table("mean_energy_run_G=1.0_24-site_10_blocks_20_width_1024_samples_2025-03-21_minSR.txt", header=None)
...
plt.title("24-site GSE For Gamma Heisenberg Honeycomb Model \nusing Kernel Formalation of SGD+SR")
plt.show()
