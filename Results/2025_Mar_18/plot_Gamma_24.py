...
samples = pd.read_table("mean_energy_run_G=1.0_24-site_10_blocks_18_width_1024_samples_2025-03-12_minSR.txt", header=None)
...
x1, x2, y1, y2 = 99000, 100000, -34.31, -34.25  # subregion of the original image
