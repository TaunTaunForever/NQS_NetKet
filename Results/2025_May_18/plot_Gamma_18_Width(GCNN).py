...
samples = pd.read_table("mean_energy_run_G=1.0_18-site_4_layers_18_width_1024_samples_2025-05-15_minSR.txt", header=None)
...
x1, x2, y1, y2 = 99000, 100000, -6.4150, -6.4025  # subregion of the original image
