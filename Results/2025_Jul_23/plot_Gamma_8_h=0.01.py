...
samples = pd.read_table("mean_energy_run_G=1.0_8-site_5_GCNN_layers_8_width_1024_samples_2025-07-23_h=0.01_SRt.txt", header=None)
samples['x'] = np.arange(0,len(samples[0]), 1)
#samples[0] -= (-4.76429835869187*4)
fig,axes = plt.subplots(1,1)
axes.set_xscale('log')
plt.axhline(y = -2.9328287027815034, color = 'r', linestyle = '-')
