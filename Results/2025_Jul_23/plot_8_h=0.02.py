...
samples = pd.read_table("mean_energy_run_G=0.0_8-site_5_GCNN_layers_8_width_1024_samples_2025-07-23_h=0.02_SRt.txt", header=None)
samples['x'] = np.arange(0,len(samples[0]), 1)
#samples[0] -= (-4.76429835869187*4)
fig,axes = plt.subplots(1,1)
axes.set_xscale('log')
plt.axhline(y = -0.13856406460550996, color = 'r', linestyle = '-')
