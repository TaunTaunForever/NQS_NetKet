...
samples = pd.read_table("mean_energy_run_G=1.0_54-site_5_GCNN_layers_20_width_1024_samples_2025-04-03_minSR.txt", header=None)
...
x1, x2, y1, y2 = 99000, 100000, -75.95, -75.72   # subregion of the original image
