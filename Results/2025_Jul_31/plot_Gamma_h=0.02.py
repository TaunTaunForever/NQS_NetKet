...
samples = pd.read_table("mean_energy_run_G=1.0_8-site_10_GCNN_layers_8_width_1024_samples_2025-07-31_SRt.txt", header=None)
...
new_samples = samples[-100:]/4

'''
x1, x2, y1, y2 = 99000, 100000, -25.632, -25.624  # subregion of the original image
