...
train_lr_stage_1_iters = int(
    os.environ.get("J1J2_NIR_LR_STAGE_1_ITERS", "200")
)
train_lr_stage_2_iters = int(
    os.environ.get("J1J2_NIR_LR_STAGE_2_ITERS", "350")
)
nir_proposal_embed_dim = int(os.environ.get("J1J2_NIR_PROPOSAL_EMBED_DIM", "8"))
...
proposal_batch = int(os.environ.get("J1J2_NIR_PROPOSAL_BATCH", str(3 * 2**6)))


run_nir_experiment(
    num_sites=8,
    j1=float(os.environ.get("J1J2_J1", "1.0")),
    j2=float(os.environ.get("J1J2_J2", "0.1")),
    ...
    embed_dim=embed_dim,
    num_heads=int(os.environ.get("J1J2_NIR_NUM_HEADS", "4")),
    num_layers=int(os.environ.get("J1J2_NIR_NUM_LAYERS", "2")),
    mlp_hidden=mlp_hidden,
    chunk_size=chunk_size,
    train_lr_stage_1=float(os.environ.get("J1J2_NIR_LR_STAGE_1", "5e-3")),
    train_lr_stage_2=float(os.environ.get("J1J2_NIR_LR_STAGE_2", "2e-3")),
    train_lr_stage_3=float(os.environ.get("J1J2_NIR_LR_STAGE_3", "5e-4")),
    ...
    target_sgd_momentum=float(os.environ.get("J1J2_NIR_TARGET_MOMENTUM", "0.5")),
    target_preconditioner=os.environ.get("J1J2_NIR_TARGET_PRECONDITIONER", "minsr"),
    target_sr_diag_shift=float(os.environ.get("J1J2_NIR_TARGET_SR_DIAG_SHIFT", "1e-4")),
    target_sr_diag_shift_stage_1=float(os.environ.get("J1J2_NIR_TARGET_SR_DIAG_SHIFT_STAGE_1", "2e-3")),
    target_sr_diag_shift_stage_2=float(os.environ.get("J1J2_NIR_TARGET_SR_DIAG_SHIFT_STAGE_2", "1e-3")),
    ...
    target_sr_momentum=(
        ...
        else float(os.environ.get("J1J2_NIR_TARGET_SR_MOMENTUM", "0.0"))
    ),
    target_sr_mode=os.environ.get("J1J2_NIR_TARGET_SR_MODE", "complex"),
    nir_proposal_batch=proposal_batch,
    nir_max_proposal_batches=int(os.environ.get("J1J2_NIR_MAX_PROPOSAL_BATCHES", "6")),
    nir_max_adaptive_rounds=int(os.environ.get("J1J2_NIR_MAX_ADAPTIVE_ROUNDS", "6")),
    nir_min_adaptive_rounds=int(os.environ.get("J1J2_NIR_MIN_ADAPTIVE_ROUNDS", "4")),
    nir_force_adapt_until_iter=int(os.environ.get("J1J2_NIR_FORCE_ADAPT_UNTIL_ITER", "250")),
    nir_ess_threshold_frac=float(os.environ.get("J1J2_NIR_ESS_THRESHOLD_FRAC", "0.4")),
    nir_efficiency_threshold_stage_1=float(os.environ.get("J1J2_NIR_EFF_STAGE_1", "0.20")),
    nir_efficiency_threshold_stage_2=float(os.environ.get("J1J2_NIR_EFF_STAGE_2", "0.20")),
    nir_efficiency_threshold_stage_3=float(os.environ.get("J1J2_NIR_EFF_STAGE_3", "0.20")),
    nir_proposal_lr_stage_1=float(os.environ.get("J1J2_NIR_PROPOSAL_LR_STAGE_1", "2e-4")),
    nir_proposal_lr_stage_2=float(os.environ.get("J1J2_NIR_PROPOSAL_LR_STAGE_2", "1e-4")),
    nir_proposal_lr_stage_3=float(os.environ.get("J1J2_NIR_PROPOSAL_LR_STAGE_3", "5e-5")),
    nir_proposal_steps_stage_1=int(os.environ.get("J1J2_NIR_PROPOSAL_STEPS_STAGE_1", "1")),
    nir_proposal_steps_stage_2=int(os.environ.get("J1J2_NIR_PROPOSAL_STEPS_STAGE_2", "1")),
    ...
    nir_prob_floor=float(os.environ.get("J1J2_NIR_PROB_FLOOR", "1e-4")),
    model_type=os.environ.get("J1J2_NIR_MODEL_TYPE", "plain"),
    run_tag=os.environ.get("J1J2_NIR_RUN_TAG", "inputproj"),
)
