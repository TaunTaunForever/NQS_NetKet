...
from vit_symm_model import CanonicalTransformEmbeddingHoneycombViT, normalise_symmetries
...
def build_model():
    return CanonicalTransformEmbeddingHoneycombViT(
        embed_dim=EMBED_DIM,
        num_heads=NUM_HEADS,
...
plt.ylabel("Energy")
plt.title(f"{NUM_SITES}-site Gamma NIR (canonical_transform)")
plt.tight_layout()
...
summary = {
    ...
    "target_model": "CanonicalTransformEmbeddingHoneycombViT",
    "symmetry_model_label": "canonical_transform",
