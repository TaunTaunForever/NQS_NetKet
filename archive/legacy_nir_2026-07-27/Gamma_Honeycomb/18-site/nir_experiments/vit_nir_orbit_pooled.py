...
from vit_symm_model import OrbitPooledInputHoneycombViT, normalise_symmetries
...
def build_model():
    return OrbitPooledInputHoneycombViT(
        embed_dim=EMBED_DIM,
        num_heads=NUM_HEADS,
...
plt.ylabel("Energy")
plt.title(f"{NUM_SITES}-site Gamma NIR (orbit_pooled)")
plt.tight_layout()
...
summary = {
    ...
    "target_model": "OrbitPooledInputHoneycombViT",
    "symmetry_model_label": "orbit_pooled",
