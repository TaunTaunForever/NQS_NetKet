...
def run_nir_experiment(
    *,
    ...
    job_base = (
        ...
        f"{num_samples_stage_1}to{num_samples_stage_3}_samples_{today}_Honeycomb_ViT_NIR_site_type_relation"
    )
    ...
    plt.ylabel("Energy")
    plt.title(f"Heisenberg Honeycomb {num_sites}-site (ViT NIR)")
    plt.tight_layout()
