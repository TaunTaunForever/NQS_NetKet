...
run_srt_experiment(
    ...
    num_samples=int(os.environ.get("J1J2_NUM_SAMPLES", "522")),
    num_iters_warm=int(os.environ.get("J1J2_NUM_ITERS_WARM", "0")),
    num_iters=int(os.environ.get("J1J2_NUM_ITERS", "1000")),
    num_samples_refine=int(os.environ.get("J1J2_NUM_SAMPLES_REFINE", "1536")),
    ...
    diag_shift_main=float(os.environ.get("J1J2_DIAG_SHIFT_MAIN", "1e-3")),
    diag_shift_refine=float(os.environ.get("J1J2_DIAG_SHIFT_REFINE", "1e-5")),
    sampler_name=os.environ.get("J1J2_SAMPLER", "local"),
    sampler_name_refine=os.environ.get("J1J2_SAMPLER_REFINE", "local"),
