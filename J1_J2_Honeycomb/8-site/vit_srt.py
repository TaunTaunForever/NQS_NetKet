...
run_srt_experiment(
    ...
    num_samples=int(os.environ.get("J1J2_NUM_SAMPLES", "512")),
    num_iters_warm=int(os.environ.get("J1J2_NUM_ITERS_WARM", "0")),
    num_iters=int(os.environ.get("J1J2_NUM_ITERS", "120")),
    chunk_size=int(os.environ.get("J1J2_CHUNK_SIZE", "256")),
    embed_dim=int(os.environ.get("J1J2_EMBED_DIM", "16")),
