...
run_nir_experiment(
    ...
    num_samples_stage_1=int(os.environ.get("J1J2_NIR_SAMPLES_STAGE_1", str(3 * 2**7))),
    num_samples_stage_2=int(os.environ.get("J1J2_NIR_SAMPLES_STAGE_2", str(3 * 2**7))),
    num_samples_stage_3=int(os.environ.get("J1J2_NIR_SAMPLES_STAGE_3", str(3 * 2**8))),
