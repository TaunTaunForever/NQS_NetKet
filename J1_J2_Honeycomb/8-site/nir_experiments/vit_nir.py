...
run_nir_experiment(
    ...
    num_samples_stage_1=int(os.environ.get("J1J2_NIR_SAMPLES_STAGE_1", str(3 * 2**9))),
    num_samples_stage_2=int(os.environ.get("J1J2_NIR_SAMPLES_STAGE_2", str(3 * 2**10))),
    num_samples_stage_3=int(os.environ.get("J1J2_NIR_SAMPLES_STAGE_3", str(3 * 2**10))),
    ...
    train_lr_stage_2=float(os.environ.get("J1J2_NIR_LR_STAGE_2", "1e-3")),
    train_lr_stage_3=float(os.environ.get("J1J2_NIR_LR_STAGE_3", "1e-4")),
