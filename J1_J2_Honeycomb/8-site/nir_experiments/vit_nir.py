...
num_iters_total = int(os.environ.get("J1J2_NIR_NUM_ITERS", "10000"))
train_lr_stage_1_iters = int(
    os.environ.get("J1J2_NIR_LR_STAGE_1_ITERS", "50")
)
train_lr_stage_2_iters = int(
    os.environ.get("J1J2_NIR_LR_STAGE_2_ITERS", "200")
)
...
proposal_batch = int(os.environ.get("J1J2_NIR_PROPOSAL_BATCH", str(3 * 2**11)))
...
run_nir_experiment(
    ...
    num_samples_stage_1=int(os.environ.get("J1J2_NIR_SAMPLES_STAGE_1", str(3 * 2**10))),
    num_samples_stage_2=int(os.environ.get("J1J2_NIR_SAMPLES_STAGE_2", str(3 * 2**10))),
    num_samples_stage_3=int(os.environ.get("J1J2_NIR_SAMPLES_STAGE_3", str(3 * 2**11))),
    ...
    train_lr_stage_2=float(os.environ.get("J1J2_NIR_LR_STAGE_2", "1e-4")),
    train_lr_stage_3=float(os.environ.get("J1J2_NIR_LR_STAGE_3", "1e-5")),
    ...
    target_sr_diag_shift_stage_1=float(os.environ.get("J1J2_NIR_TARGET_SR_DIAG_SHIFT_STAGE_1", "2e-4")),
    ...
    nir_proposal_lr_stage_1=float(os.environ.get("J1J2_NIR_PROPOSAL_LR_STAGE_1", "2e-3")),
    nir_proposal_lr_stage_2=float(os.environ.get("J1J2_NIR_PROPOSAL_LR_STAGE_2", "1e-3")),
    nir_proposal_lr_stage_3=float(os.environ.get("J1J2_NIR_PROPOSAL_LR_STAGE_3", "5e-4")),
    ...
    nir_proposal_heads=int(os.environ.get("J1J2_NIR_PROPOSAL_HEADS", "2")),
