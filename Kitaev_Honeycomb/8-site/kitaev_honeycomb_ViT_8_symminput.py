...
from kitaev_honeycomb_vit_symminput_model import HoneycombSymmInputViT
...
JOB_BASE = (
    ...
    f"{TODAY}_Kitaev_ViT_SRonly_symminput"
)
...
for start_idx in range(NUM_STARTS):
    ...
    sampler_warm = make_parallel_tempering_local(hi, NUM_SAMPLES_WARMUP)
