...
from kitaev_honeycomb_vit_symm_model import CanonicalRepresentativeHoneycombViT
...
JOB_BASE = (
    ...
    f"{TODAY}_Kitaev_ViT_NIR_inputproj"
)
...
plt.ylabel("Energy")
plt.title(f"{NUM_SITES}-site Kitaev (NIR training, input-projected)")
plt.tight_layout()
