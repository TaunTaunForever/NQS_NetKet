...
# USER OPTIONS
# ============================================================
DEFAULT_SOURCE_SUMMARY_FILE = (
    THIS_DIR
    / "runs"
    / "2026-04-17"
    / "18-site_2_layers_8_heads_2_patches_identity_3072_samples_2026-04-17_Kitaev_ViT_NIR_single_stage"
    / "summary_18-site_2_layers_8_heads_2_patches_identity_3072_samples_2026-04-17_Kitaev_ViT_NIR_single_stage.json"
)
SOURCE_SUMMARY_FILE = os.environ.get(
    "NIR_CONTINUE_SOURCE_SUMMARY", str(DEFAULT_SOURCE_SUMMARY_FILE)
)
