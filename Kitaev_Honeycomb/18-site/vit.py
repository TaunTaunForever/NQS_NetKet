...
NUM_ITERS_SR = 500       # final PT-SR refinement
...
def build_model_with_phase(*, learn_phase: bool, zero_imag_branch: bool = False):
    return HoneycombPatchViT(
        ...
        zero_imag_branch=zero_imag_branch,
        permutation=perm,
    )
...
for start_idx in range(NUM_STARTS):
    ...
    model_warm = build_model_with_phase(
        learn_phase=LEARN_PHASE_WARMUP,
        zero_imag_branch=ZERO_IMAG_BRANCH_WARMUP,
    )
...
sampler_sr = make_metropolis_local(hi, NUM_SAMPLES)
...
summary = {
    ...
    "zero_imag_branch_warmup": ZERO_IMAG_BRANCH_WARMUP,
    "embed_dim": EMBED_DIM,
    "num_heads": NUM_HEADS,
    "num_layers": NUM_LAYERS,
    "mlp_hidden_dim": MLP_HIDDEN_DIM,
